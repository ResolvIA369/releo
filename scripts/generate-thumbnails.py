...
SESSIONS = {
    ...
    3: ["rojo", "azul", "verde", "amarillo", "blanco"],
    ...
    12: ["negro", "rosa", "naranja", "violeta", "marrón"],
    ...
    24: ["lava", "cocina", "limpia", "pinta", "dibuja"],
