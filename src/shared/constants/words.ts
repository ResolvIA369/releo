...
export const PHASE2_WORDS: DomanWord[] = buildWords(
  [
    ...
    { text: "morado", category: "colores", categoryDisplay: "Colores" },
    { text: "café", category: "colores", categoryDisplay: "Colores" },
    // tamaños y formas (10)
...
export const PHASE3_WORDS: DomanWord[] = buildWords(
  [
    ...
    { text: "falda", category: "ropa", categoryDisplay: "Ropa" },
    { text: "calcetín", category: "ropa", categoryDisplay: "Ropa" },
    { text: "vestido", category: "ropa", categoryDisplay: "Ropa" },
    { text: "chaqueta", category: "ropa", categoryDisplay: "Ropa" },
    { text: "bufanda", category: "ropa", categoryDisplay: "Ropa" },
    { text: "pijama", category: "ropa", categoryDisplay: "Ropa" },
    // escuela (10)
...
export const WORD_PAIR_EXAMPLES: WordPairExample[] = [
  ...
  { displayText: "oso café", words: ["oso", "café"] },
...
export const STORY_EXAMPLES: DomanStory[] = [
  {
    ...
    pages: [
      ...
      { text: "Sol es grande y café.", audioUrl: "", imageUrl: "", highlightWords: ["grande", "café"] },
