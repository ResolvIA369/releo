...
const SYLLABLE_MAP: Record<string, string[]> = {
  ...
  negro:["ne","gro"],rosa:["ro","sa"],morado:["mo","ra","do"],café:["ca","fé"],
  ...
  falda:["fal","da"],calcetín:["cal","ce","tín"],vestido:["ves","ti","do"],chaqueta:["cha","que","ta"],
  bufanda:["bu","fan","da"],pijama:["pi","ja","ma"],
